...
public class GDocsInteractionTableAddColumn extends GDocsInteraction {
    ...
    public void perform() throws IOException, InterruptedException {
        ...
        Thread.sleep(100);
        WebActions.click(driver.findElement(By.cssSelector("[aria-label=\"Insert column right, r;\"]")));
        Thread.sleep(500);
    }
