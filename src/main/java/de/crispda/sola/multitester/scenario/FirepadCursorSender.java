...
public class FirepadCursorSender extends FirepadInteraction implements Exchanges {
    ...
    public void perform() throws IOException, InterruptedException {
        Point cursorPoint = new WebDriverWait(driver, 10)
            ...
            public Point apply(WebDriver driver) {
                WebElement cursor = driver.findElement(By.className("CodeMirror-cursor"));
