...
public class ExhaustiveExperimentTask extends ExperimentTask {
    private final SetExperimentSpec experimentSpec;
    private final int depth;
    private final GuidedStateSpaceExplorer explorer;
    private static final Logger logger = Logger.getLogger(Logger.GLOBAL_LOGGER_NAME);

    public ExhaustiveExperimentTask(SetExperimentSpec experimentSpec, String path, int depth)
    ...
    protected Void call() throws Exception {
        try {
            ...
            explorer.exhaustiveExplore(depth);
        } catch (Exception e) {
