...
public class FirepadCursorReceiver extends FirepadInteraction implements Exchanges {
    ...
    public void perform() throws IOException, InterruptedException {
        ...
        WebActions.moveToTopLeft(driver.findElement(By.className("CodeMirror-lines")))
